              ...
              <div className="animate-in fade-in slide-in-from-right-4 duration-300">
                ...
                <form className="space-y-4" onSubmit={handleLogin} id="login-form">
                  ...
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="w-full h-12 bg-primary text-primary-foreground rounded-xl font-semibold text-sm flex items-center justify-center gap-2 hover:bg-primary/90 transition-all active:scale-[0.98] mt-2 disabled:opacity-70 disabled:cursor-not-allowed"
                    id="login-submit-btn"
                  >
