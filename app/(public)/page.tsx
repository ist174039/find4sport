...
export default async function Page() {
  ...
  const [spacesCount, profsCount, eventsCount, carouselResult, proResult, spaceResult, eventResult, communityResult] = await Promise.allSettled([
  ...
  return <div className="flex min-h-screen flex-col bg-background">
    <HeroCarousel slides={carousel} spacesCount={resultCount(spacesCount)} profsCount={resultCount(profsCount)} eventsCount={resultCount(eventsCount)} />
