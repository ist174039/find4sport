'use client';
import { CheckCircle, Cookie, CreditCard, Database, Gavel, Headphones, Shield, ShieldCheck, Smile, User } from 'lucide-react'
...
<h2 className="font-semibold text-xl text-xl mb-6 text-primary">Navegação</h2>

<div className="mt-8 p-6 bg-muted/50 rounded-xl border border-border">
<Headphones className="text-primary mb-2 h-5 w-5" />
<p className="font-medium text-sm text-sm text-muted-foreground leading-tight">Dúvidas sobre os seus dados?</p>
<a className="text-primary font-semibold text-sm block mt-2 hover:underline" href="#">Contactar DPO</a>
</div>
</div>
</aside>
...
<span className="font-medium text-sm text-sm text-primary tracking-widest uppercase mb-2 block">Atualizado em 24 de Maio, 2024</span>
<h1 className="font-bold text-3xl text-display-lg text-foreground leading-tight">Política de Privacidade — FIND4SPORT</h1>
<p className="mt-6 text-base text-base text-muted-foreground max-w-2xl">
...
<h2 className="font-bold text-2xl text-2xl">1. Introdução</h2>
</div>
<div className="prose prose-slate max-w-none text-muted-foreground text-sm leading-relaxed space-y-4">
...
{/*  Data Point Card 1  */}
<div className="p-8 bg-card border border-border rounded-xl hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] transition-all">
<div className="flex justify-between items-start mb-4">
<User className="text-primary text-3xl h-5 w-5" />
<span className="px-3 py-1 bg-emerald-500/10 text-primary font-medium text-sm text-sm rounded-full">Essencial</span>
</div>
<h3 className="font-semibold text-xl text-xl mb-2">Dados de Conta</h3>
<p className="text-muted-foreground text-sm">Nome, e-mail e perfil desportivo. São utilizados para personalizar a sua experiência de treino e facilitar a comunicação com profissionais.</p>
</div>
{/*  Data Point Card 2  */}
<div className="p-8 bg-card border border-border rounded-xl hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] transition-all">
<div className="flex justify-between items-start mb-4">
<CreditCard className="text-primary text-3xl h-5 w-5" />
<span className="px-3 py-1 bg-emerald-500/10 text-primary font-medium text-sm text-sm rounded-full">Protegido</span>
</div>
<h3 className="font-semibold text-xl text-xl mb-2">Transações</h3>
<p className="text-muted-foreground text-sm">Histórico de reservas e pagamentos. Processamos através de gateways encriptados de nível bancário para garantir segurança absoluta.</p>
</div>
</div>
...
<h2 className="font-bold text-2xl text-2xl">2. Recolha de Dados</h2>
</div>
<div className="bg-muted/50 p-8 rounded-2xl border border-border mb-6">
<ul className="space-y-6">
<li className="flex gap-4">
<CheckCircle className="text-primary mt-1 h-5 w-5" />
<div>
<span className="font-semibold text-foreground block">Fornecidos pelo Utilizador</span>
<span className="text-muted-foreground">Informações de registo, biografia de treinador, certificações e preferências de modalidades.</span>
</div>
</li>
<li className="flex gap-4">
<CheckCircle className="text-primary mt-1 h-5 w-5" />
<div>
<span className="font-semibold text-foreground block">Recolhidos Automaticamente</span>
<span className="text-muted-foreground">Endereço IP, tipo de dispositivo, cookies de sessão e dados de geolocalização para busca de treinos próximos.</span>
</div>
</li>
</ul>
</div>
...
<h4 className="text-white font-bold text-3xl text-2xl max-w-md">Segurança em cada movimento.</h4>
</div>
</div>
...
<h2 className="font-bold text-2xl text-2xl">3. Uso de Cookies</h2>
</div>
<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
<div className="p-6 border border-border rounded-xl text-center">
<h4 className="font-bold text-foreground mb-2">Funcionais</h4>
<p className="text-sm text-muted-foreground">Permitem login e carrinho.</p>
</div>
<div className="p-6 border border-border rounded-xl text-center">
<h4 className="font-bold text-foreground mb-2">Analíticos</h4>
<p className="text-sm text-muted-foreground">Para melhorar a plataforma.</p>
</div>
<div className="p-6 border border-border rounded-xl text-center">
<h4 className="font-bold text-foreground mb-2">Marketing</h4>
<p className="text-sm text-muted-foreground">Apenas com seu consentimento.</p>
</div>
</div>
</section>
...
<h2 className="font-bold text-2xl text-2xl">4. Seus Direitos</h2>
</div>
<div className="prose prose-slate max-w-none text-muted-foreground text-sm leading-relaxed">
...
<ShieldCheck className="text-tertiary text-4xl h-5 w-5" />
<h2 className="font-bold text-2xl text-2xl text-tertiary">5. Conformidade RGPD</h2>
</div>
...
<Shield className="text-tertiary text-6xl h-5 w-5" />
</div>
</div>
</section>
</div>
