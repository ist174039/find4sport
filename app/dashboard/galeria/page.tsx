...
export default async function GaleriaPage() {
  ...
  return <div className="space-y-6"><div><h1 className="text-3xl font-bold tracking-tight">Galeria de Fotos</h1><p className="mt-2 text-muted-foreground">Gira fotografias, visibilidade, capa e imagem de perfil.</p></div><GaleriaManagerV2 userId={user.id} entity={{ type: access.role, data: entityResult.data }} maxPhotos={maxPhotos} /></div>
}
