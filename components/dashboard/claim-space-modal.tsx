      ...
      <DialogContent className="sm:max-w-md">
        ...
        {!submitted && space ? (
          <div className="space-y-5 py-2">
            ...
            <div className="rounded-xl border border-primary/15 bg-primary/[0.03] p-3 text-xs leading-relaxed text-muted-foreground">O pedido será analisado pela equipa administrativa. Se forem necessários comprovativos adicionais, entraremos em contacto através de um canal seguro.</div>
