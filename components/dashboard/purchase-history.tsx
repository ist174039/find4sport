...
export type PurchaseRow={id:string;reservationId?:string|null;kind:string;title:string;provider:string;date:string;time:string;startTime?:string;endTime?:string;amount:number;status:string;paymentStatus:string|null;href:string;location?:string|null}
