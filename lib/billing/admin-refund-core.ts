export type RefundInput={reservationId:string;chargeId?:string|null;paymentIntentId?:string|null;transferId?:string|null;reason:string}
export type Transfer={id:string;amount:number;amount_reversed?:number|null}
export type Reversal={id:string;amount:number}
