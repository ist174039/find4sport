...
import { Activity, Bell, Building2, Calendar, CalendarCheck, Camera, DollarSign, Heart, LayoutDashboard, MessageSquare, ReceiptText, Settings, Star, User, UserRound, Users } from 'lucide-react'
...
export function getDashboardPrimaryNavigation(role:PlatformRole):DashboardNavItem[]{
  if(role==='athlete')return[
    ...
    {name:'Agenda',href:`${base}/agenda`,icon:Calendar},
    {name:'Compras',href:`${base}/compras`,icon:ReceiptText},
    {name:'Mensagens',href:`${base}/mensagens`,icon:MessageSquare},
  ]
  return[
    {name:'Início',href:base,icon:LayoutDashboard},
